...
execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 unless score difficulty timer_settings matches 2.. unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 1 run titleraw @a[tag=trust_player_control] actionbar {"rawtext":[{"text":"§lTimer §7Ultimate§r §5("},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s) §f§oby TheFelixLive"}]}
execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 if score difficulty timer_settings matches 2.. unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 1 run titleraw @a[tag=trust_player_control] actionbar {"rawtext":[{"text":"§lTimer §7Ultimate§r §c("},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s) §f§oby TheFelixLive"}]}

execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 unless score difficulty timer_settings matches 2.. unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 0 run titleraw @a[tag=trust_player_control] actionbar {"rawtext":[{"text":"§lTimer §7Ultimate§r §f§oby TheFelixLive"}]}

# for player thay dont have the trust_player_control
execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 unless score difficulty timer_settings matches 2.. unless score enchant timer_addon matches 1.. run titleraw @a[tag=!trust_player_control] actionbar {"rawtext":[{"text":"§lTimer §7Ultimate§r §f§oby TheFelixLive"}]}


execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 if score difficulty timer_settings matches 2 unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§lTimer §7Ultimate §4[§cHardcore Mode§4]§r §f§oby TheFelixLive"}]}
execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 if score difficulty timer_settings matches 3 unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§lTimer §7Ultimate §4[§cUltra Hardcore§4]§r §f§oby TheFelixLive"}]}
execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 0 if score difficulty timer_settings matches 4 unless score enchant timer_addon matches 1.. if score shoud_count_down timer_settings matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§lTimer §7Ultimate §4[§7Infinity§4]§r §f§oby TheFelixLive"}]}

execute if score mode timer_settings matches 0 if score speed_run timer_settings matches 1 run titleraw @a actionbar {"rawtext":[{"text":"§l§u00:0§d0.00"}]}

# Normal

# time_second
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 0.. if score min timer_time matches 0 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}

# time_minuten
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 1.. if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}


# time_hours
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 0 if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 1.. if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 0..1 unless score enchant timer_addon matches 1.. if score sec timer_time matches 1.. if score min timer_time matches 1.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§f"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}

# Hardcore

# time_second
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 0.. if score min timer_time matches 0 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}

# time_minuten
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 1.. if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}


# time_hours
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 0 if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 1.. if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m"}]}
execute if score do_count timer_settings matches 1 if score speed_run timer_settings matches 0 if score mode timer_settings matches 1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 1.. if score min timer_time matches 1.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§c"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s"}]}

# Speed Run

# time_minuten
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches ..9 if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches ..9 if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}

execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches ..9 if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches ..9 if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}


# Stunden
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches ..9 if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches 10.. if score sec timer_time matches ..9 if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"."},{"score":{"name":"ms","objective":"timer_time"}}]}

execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches ..9 if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}
execute if score mode timer_settings matches 1 if score speed_run timer_settings matches 1 if score ms timer_time matches ..9 if score sec timer_time matches ..9 if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}},{"text":".0"},{"score":{"name":"ms","objective":"timer_time"}}]}


# Pause

# time_second
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 0.. if score min timer_time matches 0 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s §f§o(frozen)"}]}

# time_minuten
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m §f§o(frozen)"}]}
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 1.. if score min timer_time matches 1.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"min","objective":"timer_time"}},{"text":"m "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s §f§o(frozen)"}]}


# time_hours
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 0 if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h §f§o(frozen)"}]}
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 1.. if score min timer_time matches 0 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"sec","objective":"timer_time"}},{"text":"s §f§o(frozen)"}]}
execute if score do_count timer_settings matches 0 if score mode timer_settings matches 1 if score sec timer_time matches 0 if score min timer_time matches 1.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"h","objective":"timer_time"}},{"text":"h "},{"score":{"name":"min","objective":"timer_time"}},{"text":"m §f§o(frozen)"}]}
...
execute if score mode timer_settings matches 2 if score reset_type timer_settings matches 0..1 if score difficulty timer_settings matches 2.. if score sec timer_time matches 0 if score min timer_time matches 0 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§4[§cEnde§4]"}]}

# time_minuten
execute if score mode timer_settings matches 2 if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches 1..9 if score min timer_time matches 10.. if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches 1..9 if score min timer_time matches ..9 if score h timer_time matches 0 run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}}]}

# Stunden
execute if score mode timer_settings matches 2 if score sec timer_time matches 10.. if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches 10.. if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches ..9 if score min timer_time matches 10.. if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}}]}
execute if score mode timer_settings matches 2 if score sec timer_time matches ..9 if score min timer_time matches ..9 if score h timer_time matches 1.. run titleraw @a actionbar {"rawtext":[{"text":"Your Time: §7§l"},{"score":{"name":"h","objective":"timer_time"}},{"text":":0"},{"score":{"name":"min","objective":"timer_time"}},{"text":":0"},{"score":{"name":"sec","objective":"timer_time"}}]}
