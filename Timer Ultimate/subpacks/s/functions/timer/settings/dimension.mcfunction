...
execute if entity @s[tag=trust_player_control] if score speed_run timer_settings matches 0 if score mode timer_settings matches 0 unless block ~ ~1 ~ air run setblock ~ ~1 ~ air
execute if entity @s[tag=trust_player_control] if score speed_run timer_settings matches 0 if score mode timer_settings matches 0 if score dimension timer_settings matches 0 if block ~ ~-1 ~ air run setblock ~ ~-1 ~ stone
execute if entity @s[tag=trust_player_control] if score speed_run timer_settings matches 0 if score mode timer_settings matches 0 if score dimension timer_settings matches 1 if block ~ ~-1 ~ air run setblock ~ ~-1 ~ netherrack
execute if entity @s[tag=trust_player_control] if score speed_run timer_settings matches 0 if score mode timer_settings matches 0 if score dimension timer_settings matches 2 if block ~ ~-1 ~ air run setblock ~ ~-1 ~ end_stone
...
# Error
execute if entity @s[tag=trust_player_control] if score speed_run timer_settings matches 0 if score mode timer_settings matches 0 if score only timer_addon matches 1.. run tellraw @s {"rawtext":[{"text":"§l§u[§dInfo§u]§r The only challenge is not compatible with the dimension function and has been disabled!"}]}
