...
execute if score @s timer_show_actionbar matches 0 run tellraw @s {"rawtext":[{"text":"§l§7[§fSystem§7]§r Timer is §8invisible"}]}
...
execute if score @s timer_show_actionbar matches 1 if score custom_music timer_settings matches 1 run playsound timeru.continue @s
