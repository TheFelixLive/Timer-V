...
execute if entity @a[tag=on_start_challage] if score mode timer_settings matches 0 if score no_jump timer_addon matches 1 run tellraw @a[tag=trust_player_control] {"rawtext":[{"text":"§l§f[§5Info§f]§r If someone jump, the run is over!"}]} 
execute if entity @a[tag=on_start_challage] if score mode timer_settings matches 0 if score no_move timer_addon matches 1 run tellraw @a[tag=trust_player_control] {"rawtext":[{"text":"§l§f[§5Info§f]§r You are no longer able to move"}]}
execute if entity @a[tag=on_start_challage] if score mode timer_settings matches 0 if score no_move timer_addon matches 2 run tellraw @a[tag=trust_player_control] {"rawtext":[{"text":"§l§f[§5Info§f]§r You are no longer able to move and look around"}]}
...
execute if entity @a[tag=on_start_challage] if score mode timer_settings matches 0 if score no_swimming timer_addon matches 1 run tellraw @a[tag=trust_player_control] {"rawtext":[{"text":"§l§3[§bInfo§3]§r If someone starts swimming, the run is over!"}]} 
